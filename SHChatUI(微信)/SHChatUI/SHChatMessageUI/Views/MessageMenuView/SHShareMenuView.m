...
- (void)setup {
    if (!_shareMenuItemButton) {
        ...
        shareMenuItemButton.frame = CGRectMake(0, 0, kXHShareMenuItemWH, kXHShareMenuItemWH);
        shareMenuItemButton.layer.cornerRadius = 10;
        shareMenuItemButton.layer.borderColor = RGB(218, 223, 225, 1).CGColor;
        shareMenuItemButton.layer.borderWidth = 1;
        shareMenuItemButton.backgroundColor = RGB(246, 250, 252, 1);
    ...
    if (!_shareMenuItemTitleLabel) {
        UILabel *shareMenuItemTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.shareMenuItemButton.frame), kXHShareMenuItemWH, KXHShareMenuItemHeight - kXHShareMenuItemWH)];
        shareMenuItemTitleLabel.font = [UIFont systemFontOfSize:12];
        shareMenuItemTitleLabel.textAlignment = NSTextAlignmentCenter;
        shareMenuItemTitleLabel.textColor = RGB(154, 155, 156, 1);
...
- (void)reloadData {
    ...
    CGFloat paddingX = (kSHWIDTH - kSHShareMenuPerRowItemCount*kXHShareMenuItemWH)/(kSHShareMenuPerRowItemCount + 1);
    CGFloat paddingY = KXHShareMenuItemTop;
    ...
    for (SHShareMenuItem *shareMenuItem in self.shareMenuItems) {
        ...
        CGRect shareMenuItemViewFrame = [self getFrameWithPerRowItemCount:kSHShareMenuPerRowItemCount perColumItemCount:kSHShareMenuPerColum itemWidth:kXHShareMenuItemWH itemHeight:KXHShareMenuItemHeight paddingX:paddingX paddingY:paddingY atIndex:index onPage:page];
...
- (void)setup {
    ...
    if (!_shareMenuPageControl) {
        ...
        shareMenuPageControl.currentPageIndicatorTintColor = RGB(138, 138, 138, 1);
        shareMenuPageControl.pageIndicatorTintColor = RGB(186, 186, 186, 1);
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.backgroundColor = RGB(228, 237, 244, 1);
        self.alpha = 0.0;
