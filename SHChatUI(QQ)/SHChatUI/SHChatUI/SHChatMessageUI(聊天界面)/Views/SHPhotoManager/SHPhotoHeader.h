...
#ifndef SHPhotoHeader_h
#define SHPhotoHeader_h
...
//下方按钮字体颜色
#define BTNCOLOR RGBColor(26, 117, 215)
...
#define ShowMsg(_msg) [[[SHMessageTool alloc]init]ToastMessage:_msg]
...
#endif /* SHPhotoHeader_h */

/*
 PHAsset: 代表照片库中的一个资源，跟 ALAsset 类似，通过 PHAsset 可以获取和保存资源
 PHFetchOptions: 获取资源时的参数，可以传 nil，即使用系统默认值
 PHFetchReSHlt: 表示一系列的资源集合，也可以是相册的集合
 ...
 enum PHAssetCollectionSHbtype : Int {
